// Bare-metal platform implementation for remdb
// This crate contains inherently unsafe bare-metal operations.
// #![allow(unsafe_code)] is required because hardware-level operations
// (raw pointer I/O, timer stubs) are inherently unsafe.
// SAFETY: Each unsafe block is documented with its safety invariants.
// This is a stub implementation for bare-metal targets.
#![allow(unsafe_code)]

use remdb::platform::{Platform, FileMode, FileHandle, SeekWhence, FileResult};
use core::ptr;
